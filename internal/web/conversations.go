...
func (s *Server) searchConversationSeeds(ctx context.Context, userID int64, q string, sortMode search.SortMode, page, pageSize int, opts search.SearchOptions, own map[string]bool) ([]store.MessageRecord, error) {
	seeds, err := s.searchConversationSeedHits(ctx, userID, q, sortMode, page, pageSize, opts, own)
	if err != nil {
		return nil, err
	}
...
func (s *Server) searchConversationSeedHits(ctx context.Context, userID int64, q string, sortMode search.SortMode, page, pageSize int, opts search.SearchOptions, own map[string]bool) ([]conversationSeed, error) {
