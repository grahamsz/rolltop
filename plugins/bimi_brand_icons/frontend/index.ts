// File overview: BIMI brand-icon frontend helpers. The plugin bundle exports the
// domain batching and URL lookup helpers used by the core mail views.
...
export default {
  senderDomain,
  brandDomainKeyForThread,
  loadBrandIconsForDomains,
  bimiSenderVisualURL
};
