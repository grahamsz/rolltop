...
RUN set -eu; \
	plugins='attachment_preview bimi_brand_icons gravatar_sender_icons language_search mail_filters one_click_unsubscribe remote_image_blocklist trusted_image_sources client_side_pgp'; \
